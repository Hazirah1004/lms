...
class AppliesControllerTest < ActionController::TestCase
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post :create, apply: { address_on_leave: @apply.address_on_leave, end_date: @apply.end_date, leave_type: @apply.leave_type, replace_person: @apply.replace_person, start_date: @apply.start_date }
    end
  ...
  test "should update apply" do
    patch :update, id: @apply, apply: { address_on_leave: @apply.address_on_leave, end_date: @apply.end_date, leave_type: @apply.leave_type, replace_person: @apply.replace_person, start_date: @apply.start_date }
    assert_redirected_to apply_path(assigns(:apply))
  end
